...
{
	public class ShowMultiCurveForm : System.Windows.Forms.Form
	{
		private System.ComponentModel.IContainer components = null;

		private RibbonClientPanel ribbonClientPanel1;

		private MultiLineChartControl chartControl;
		...
		public System.Collections.Generic.List<float[]> m_ChartDatas = new System.Collections.Generic.List<float[]>();

		public System.Collections.Generic.List<string> m_ChartDataNames = new System.Collections.Generic.List<string>();

		public System.Collections.Generic.List<System.Drawing.Color> m_ChartDataColors = new System.Collections.Generic.List<System.Drawing.Color>();

		public string[] m_ChartXAxisPointStrings = null;

		public MultiLineChartControl _ChartControl
		{
			get
			{
		...
		private void InitializeComponent()
		{
			...
			this.chartControl = new MultiLineChartControl();
			...
			this.chartControl.ChartDataColors = null;
			this.chartControl.ChartDataNames = null;
			this.chartControl.ChartDatas = null;
			this.chartControl.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
			...
			this.chartControl.ShowContextMenu = true;
			...
			base.Name = "ShowMultiCurveForm";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "标题";
			base.Load += new System.EventHandler(this.ShowMultiCurveForm_Load);
			this.ribbonClientPanel1.ResumeLayout(false);
			base.ResumeLayout(false);
		}

		public ShowMultiCurveForm()
		{
			this.InitializeComponent();
		}

		private void ShowMultiCurveForm_Load(object sender, System.EventArgs e)
		{
			this.Text = this.m_FormTitle;
			this.chartControl.BarChartParams = this.m_ChartParams;
			this.chartControl.ShowChartData(this.m_ChartDatas, this.m_ChartDataNames, this.m_ChartDataColors, this.m_ChartTitle, this.m_ChartXAsixName, this.m_ChartYAxisName, this.m_ChartXAxisPointStrings);
		}
