...
{
	public class wChinaMasker : wBaseMasker
	{
		public wChinaMasker()
		{
		...
		public wChinaMasker(System.Drawing.Size maskerSize, Projection mapPrj, System.Drawing.Color transparentColor)
		{
		...
		public override System.Drawing.Bitmap CreateMasker()
		{
			...
			System.IO.MemoryStream ms = new System.IO.MemoryStream(Resources.China_Boundary);
